defmodule MingleMeWeb.CoreComponents do
  @moduledoc """
  ...
  use Gettext, backend: MingleMeWeb.Gettext
  ...
  attr :type, :string,
    ...
    values: ~w(checkbox color date datetime-local email file month number password
               search select tel text textarea time url week checkgroup)
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MingleMeWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MingleMeWeb.Gettext, "errors", msg, opts)
    end
  end
